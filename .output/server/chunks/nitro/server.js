global.__timing__.logStart('Load chunks/nitro/server');'use strict';
...
const _events__default = /*#__PURE__*/_interopDefaultLegacy(_events);
...
const require$$7 = /*@__PURE__*/getAugmentedNamespace(lib);

commonjsGlobal.fetch = commonjsGlobal.fetch || require$$7.default || require$$7;
commonjsGlobal.Request = commonjsGlobal.Request || require$$7.Request;
commonjsGlobal.Response = commonjsGlobal.Response || require$$7.Response;
commonjsGlobal.Headers = commonjsGlobal.Headers || require$$7.Headers;
...
const runtimeConfig = {"public":{},"private":{}};
for (const type of ["private", "public"]) {
  for (const key in runtimeConfig[type]) {
    runtimeConfig[type][key] = dist(process.env[key] || runtimeConfig[type][key]);
  }
}
...
function createApp(options = {}) {
  ...
  app.useAsync = (arg1, arg2) => use(app, arg1, arg2 !== void 0 ? arg2 : {promisify: false}, {promisify: false});
  return app;
}
...
function destr$1(val) {
  ...
  if (!JsonSigRx$1.test(val)) {
    return val;
  }

  try {
    if (suspectProtoRx$1.test(val) || suspectConstructorRx$1.test(val)) {
      return JSON.parse(val, jsonParseTransform$1);
    }
...
var Stream = _interopDefault(Stream__default['default']);
...
var zlib = _interopDefault(zlib__default['default']);
...
/*@__PURE__*/getDefaultExportFromCjs(lib$1);
...
class Readable extends _events__default['default'].EventEmitter {
  constructor(_opts) {
    super();
...
var writable = createCommonjsModule(function (module, exports) {
...
class Writable extends _events__default['default'].EventEmitter {
  constructor(_opts) {
    super();
    this.writable = true;
...
var rawHeaders_1 = rawHeaders;
var mergeFns_1 = mergeFns;
...
const ReadableAndWritable = class {
  constructor(readable$1 = new readable.Readable(), writable$1 = new writable.Writable()) {
    Object.assign(this, readable$1);
    Object.assign(this, writable$1);
    this._destroy = (0, utils.mergeFns)(readable$1._destroy, writable$1._destroy);
  }

};
Object.assign(ReadableAndWritable.prototype, readable.Readable.prototype);
Object.assign(ReadableAndWritable.prototype, writable.Writable.prototype);
...
class IncomingMessage extends readable.Readable {
  constructor(socket$1) {
    ...
    this.statusMessage = "";
    this.readable = false;
    this.socket = this.connection = socket$1 || new socket.Socket();
  }

  get rawHeaders() {
    return (0, utils.rawHeaders)(this.headers);
  }
...
/*@__PURE__*/getDefaultExportFromCjs(request);
...
class ServerResponse extends writable.Writable {
  constructor(req) {
    super();
    this.statusCode = 200;
    this.statusMessage = "";
...
/*@__PURE__*/getDefaultExportFromCjs(response);

var createCall_1 = createCall;
...
function createCall(handle) {
  return function callHandle(context) {
    ...
    const res = new response.ServerResponse(req);
    req.url = context.url || "/";
...
var call = /*#__PURE__*/Object.defineProperty({
	createCall: createCall_1
}, '__esModule', {value: true});
...
Object.keys(call).forEach(function (key) {
  ...
  if (key in exports && exports[key] === call[key]) return;
...
function createFetch(call, _fetch = commonjsGlobal.fetch) {
...
const globalTiming = global.__timing__ || {
  start: () => 0,
  end: () => 0,
  metrics: []
};
...
const _d0bee8 = () => Promise.resolve().then(function () { return require('./static.js'); });

const middleware = [
  { route: '/', handle: _d0bee8, lazy: true, promisify: true }
];

const app = createApp_1({
  debug: dist(false),
  onError: handleError
});
app.use(timingMiddleware);
app.use(middleware);
app.use(() => Promise.resolve().then(function () { return require('../app/render.js'); }).then((e) => e.renderMiddleware), {lazy: true});
const handle = useBase_1("/", app);
const localCall = fetch$1.createCall(handle);
const localFetch = fetch$1.createFetch(localCall, global.fetch);
global.$fetch = createFetch({fetch: localFetch});

const server = new http.Server(handle);
const port = dist(process.env.NUXT_PORT || process.env.PORT) || 3e3;
...
exports.createError_1 = createError_1;
exports.getDefaultExportFromCjs = getDefaultExportFromCjs;
exports.proxy = proxy;
exports.require$$7 = require$$7;
exports.server = server$1;;global.__timing__.logEnd('Load chunks/nitro/server');
